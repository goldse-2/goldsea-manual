...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
    ...
    <div id="recommend-section" class="mb-10">
        <div class="flex justify-between items-center mb-5">
            ...
            <button onclick="regenerateRecommendations()" class="bg-gradient-to-r from-amber-400 to-orange-400 hover:from-amber-500 hover:to-orange-500 text-white font-bold py-2 px-4 rounded-full shadow-md transform transition hover:-translate-y-0.5 text-sm md:text-base">
                🔄 换一批
            </button>
        </div>
